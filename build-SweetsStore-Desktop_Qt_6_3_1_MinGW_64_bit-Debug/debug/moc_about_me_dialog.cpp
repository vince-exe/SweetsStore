/****************************************************************************
** Meta object code from reading C++ file 'about_me_dialog.h'
**
...
#include <memory>
#include "../../SweetsStore/SweetsStore/about_me_dialog.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'about_me_dialog.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_AboutMeDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_AboutMeDialog_t qt_meta_stringdata_AboutMeDialog = {
    {
QT_MOC_LITERAL(0, 13) // "AboutMeDialog"
...
const QMetaObject AboutMeDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_AboutMeDialog.offsetsAndSize,
    qt_meta_data_AboutMeDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_AboutMeDialog_t
, QtPrivate::TypeAndForceComplete<AboutMeDialog, std::true_type>
